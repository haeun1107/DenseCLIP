...
class POLYPDataset(CustomDataset):
    ...
    def __init__(self, split, **kwargs):
        ...
        self.gt_seg_map_loader = self._gt_loader_polyp
    ...
    def load_annotations(self, img_dir, img_suffix, ann_dir, seg_map_suffix,
        ...
        print(f'[POLYPDataset] Loaded {len(data_infos)} samples from {self.split}')
        return data_infos
    ...
    def _gt_loader_polyp(self, results):
    ...
    def get_gt_seg_map_by_filename(self, seg_map_filename):
        res = dict(ann_info=dict(seg_map=seg_map_filename),
                   seg_prefix=None)
        return self._gt_loader_polyp(res)['gt_semantic_seg']
