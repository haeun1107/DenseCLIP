...
- Keeps the SAME relative path & filename as the input image
  ...
  -> out_dir/patient101/patient101_frame01.nii.gz
"""
...
def parse_args():
    ...
    p.add_argument('--dtype', default='uint8', choices=['uint8','uint16','int16','int32'],
                  help='NIfTI integer dtype for labels')
    p.add_argument('--keep-prob', action='store_true',
...
def _save_as_nifti_like(src_img_path, label2d, out_path, dtype='uint8'):
    ...
    # NIfTI expects at least 2D (H,W); this is fine
