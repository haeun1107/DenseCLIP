_base_ = [
    ...
    '_base_/datasets/isic_stage2.py',
...
custom_imports = dict(
    imports=[
        'mmseg.datasets.isic',
        'mmseg.datasets.pipelines.load_isic_annotation'
    ],
...
load_from = 'work_dirs/ISIC/denseclip_fpn_res50_512x512_80k_isic_fix/iter_61600.pth'
device = 'cuda'
