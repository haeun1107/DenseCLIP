# segmentation/configs/denseclip_fpn_res50_512x512_80k_acdc_stage2.py
_base_ = [
    '_base_/models/denseclip_r50.py',
    '_base_/datasets/acdc_stage2.py',
...
model = dict(
    ...
    class_names=['background', 'right ventricle cavity',
                 'myocardium', 'left ventricle cavity']
)
...
load_from = 'data/ACDC/iter_58400.pth'
device = 'cuda'
