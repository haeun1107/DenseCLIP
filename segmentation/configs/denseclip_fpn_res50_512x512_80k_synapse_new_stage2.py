_base_ = [
    ...
    '_base_/datasets/synapse_new_stage2.py',   # ← 우리가 만든 NPZ 데이터셋 설정
...
load_from = '/home/haeun1107/decs_jupyter_lab/DenseCLIP/work_dirs/denseclip_fpn_res50_512x512_80k_synapse_new/iter_57600.pth'
