_base_ = [
    ...
    '_base_/datasets/polyp_Kvasir_stage2.py',
...
load_from = '/home/haeun1107/decs_jupyter_lab/DenseCLIP/work_dirs/denseclip_fpn_res50_512x512_80k_polyp_Kvasir/iter_41600.pth'
